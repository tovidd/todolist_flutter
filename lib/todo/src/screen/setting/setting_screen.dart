...
class SettingScreen extends StatelessWidget {
  ...
  Widget body(BuildContext context) {
    return ListView(
      children: <Widget>[
          ...
          setting_content(context, 'Connected With Google', 'Tap To Manage', 'assets/ic_google.png', Icon(null, size: 25), Colors.white),
        ],
  ...
  Widget setting_content(BuildContext context,String title, String desription, String image, Icon icon, Color icon_bc) {
    return Container(
