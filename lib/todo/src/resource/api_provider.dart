...
class ApiProvider {
  ...
  final _suffix_setting_profile_information= '5e212fa32f0000670077d4ae?mocky-delay=5000ms'; //success 
  ...
  final _suffix_push_notifications= '5e3253ba3200005f0094cdab?mocky-delay=5000ms';
